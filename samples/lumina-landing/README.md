...
├── golden_trajectory.json        # Reference trajectory (files a successful run produces)
├── prototypes/                   # Reference screenshots, one per VS-capture group
│   ├── Homepage.jpg
│   ├── Homepage Tablet.jpg
│   ├── Homepage Mobile.jpg
│   └── Mobile Menu.jpg
...
#    Records results/frontend/openhands/claude-opus-4-8/lumina-landing/trajectory.json (the chain-of-thought dump).
